...
sp_exponencial_log <- as_Spatial(exponencial_log)

bw.fixed <- bw.gwr(formula = log_krig_e ~ DIST_AGUA  
                   + DIST_C_SALUD + DIST_ESCUELAS  +
                     ...
                     DIST_AREA_INUNDABLE + 
                     DIST_PARADAS_BUS,
                   data=sp_exponencial_log, adaptive=FALSE)

gwr.fixed.gaussian <- gwr.basic(log_krig_e ~ DIST_AGUA  
                                + DIST_C_SALUD + DIST_ESCUELAS  +
                                  DIST_ESPACIOS_V + DIST_BARRIOS + 
                                  DIST_ESTACIONES +  
                                  DIST_RED_VIAL + 
                                  DIST_AREA_INUNDABLE + 
                                  DIST_PARADAS_BUS, data=sp_exponencial_log, bw=bw.fixed, 
                       kernel = "gaussian", longlat = FALSE)
gwr.fixed.gaussian

gwr.fixed.exponential <- gwr.basic(formula = log_krig_e ~ DIST_AGUA  
                                   + DIST_C_SALUD + DIST_ESCUELAS  +
                                     DIST_ESPACIOS_V + DIST_BARRIOS + 
                                     DIST_ESTACIONES +  
                                     DIST_RED_VIAL + 
...
#GWR fixed:0.6517198 - kernel exponencial - 0.6570797 gaussiano

##GWR con banda adaptive

bw.adaptive <- bw.gwr(formula = log_krig_e ~ DIST_AGUA  
                      + DIST_C_SALUD + DIST_ESCUELAS  +
                        DIST_ESPACIOS_V + DIST_BARRIOS + 
                        DIST_ESTACIONES +  
                        DIST_RED_VIAL + 
                        DIST_AREA_INUNDABLE + 
                        DIST_PARADAS_BUS,
                   data=sp_exponencial_log, adaptive=TRUE)

gwr.adaptive.gaussian <- gwr.basic(formula = log_krig_e ~ DIST_AGUA  
                                   + DIST_C_SALUD + DIST_ESCUELAS  +
                                     DIST_ESPACIOS_V + DIST_BARRIOS + 
                                     DIST_ESTACIONES +  
                                     DIST_RED_VIAL + 
                                     DIST_AREA_INUNDABLE + 
                                     DIST_PARADAS_BUS, data=sp_exponencial_log, 
                         bw=bw.adaptive, 
                       kernel = 'gaussian', adaptive=TRUE, longlat = FALSE)

gwr.adaptive.gaussian

gwr.adaptive.exponential <- gwr.basic(formula = log_krig_e ~ DIST_AGUA  
                                      + DIST_C_SALUD + DIST_ESCUELAS  +
                                        DIST_ESPACIOS_V + DIST_BARRIOS + 
                                        DIST_ESTACIONES +  
                                        DIST_RED_VIAL + 
                                        DIST_AREA_INUNDABLE + 
                                        DIST_PARADAS_BUS, data=sp_exponencial_log, bw=bw.adaptive, 
                                   kernel = "exponential", adaptive=TRUE, longlat = FALSE)
gwr.adaptive.exponential

#GWR adaptive: 0.8042812 gaussian - 0.7655604 exponential
...
#exportar shapefile
st_write(sp.gwr.fixed.gaussian.r2, "C:/Users/leand/Desktop/Pilar_ECTAAE/R_OLS_GWR/Output/exp_log/R2_local/sp_gwr_fixed_gaussian_r2.shp")
st_write(sp.gwr.fixed.gaussian.r2, "C:/Users/leand/Desktop/Pilar_ECTAAE/R_OLS_GWR/Output/exp_log/R2_local/sp.gwr.fixed.exponential.r2.shp")
st_write(sp.gwr.adaptive.gaussian.r2, "C:/Users/leand/Desktop/Pilar_ECTAAE/R_OLS_GWR/Output/exp_log/R2_local/sp.gwr.adaptive.gaussian.r2.shp")
st_write(sp.gwr.adaptive.exponential.r2, "C:/Users/leand/Desktop/Pilar_ECTAAE/R_OLS_GWR/Output/exp_log/R2_local/sp.gwr.adaptive.exponential.r2.shp")
